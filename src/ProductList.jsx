...
function ProductList({ onHomeClick }) {
    ...
    const [addedToCart, setAddedToCart] = useState({}); // Tracks which products are added
    ...
    const linkStyle = { color: 'white', fontSize: '30px', textDecoration: 'none' };
        ...
        <div>
            <div className="navbar" style={navbarStyle}>
                <div className="luxury">
                    ...
                    <a href="/" onClick={handleHomeClick}><h3 style={{ color: 'white' }}>Paradise Nursery</h3><i>Where Green Meets Serenity</i></a>
                </div>
                <div>
                    <a href="#" onClick={handlePlantsClick} style={linkStyle}>Plants</a>
                    <a href="#" onClick={handleCartClick} style={linkStyle}>
                        <span className='cart-icon'>Cart ({calculateTotalQuantity()})</span>
                    </a>
                </div>
            </div>
